...
# CONFIGURATION
# ==========================================================
ROOT_DIR = r"C:\Development\Git\MGS3-PS2-Textures"
DEST_DIR = r"C:\Development\Git\MGS3-PS2-Textures\final_verification_nov22_2025"
CONFLICT_DIR = os.path.join(DEST_DIR, "conflicted")
DIMENSIONS_CSV = r"C:\Development\Git\MGS3-PS2-Textures\u - dumped from subsistence\mgs3_mc_dimensions.csv"
PS2_DIMENSIONS_CSV = r"C:\Development\Git\MGS3-PS2-Textures\u - dumped from subsistence\mgs3_ps2_dimensions.csv"
PCSX2_SHA1_LOG = r"C:\Development\Git\MGS3-PS2-Textures\pcsx2_dumped_sha1_log.csv"

PASS1_CSV = r"C:\Development\Git\MGS3-PS2-Textures\pcsx2_mc_sha1_matches.csv"
PASS2_CSV = r"C:\Development\Git\MGS3-PS2-Textures\pcsx2_tri_sha1_matches.csv"
MANUAL_CSV = r"C:\Development\Git\MGS3-PS2-Textures\pcsx2_manual_sha1_matches.csv"
...
def check_external_wrong_dimensions(ps2_csv, root_dir, dest_dir, exclude_dirs):
    ...
    texture_map_csv = os.path.join(ROOT_DIR, "u - dumped from subsistence", "mgs3_texture_map.csv")
    ...
    # =====================================================
    FOLDER_BLACKLIST = [
        r"C:\Development\Git\MGS3-PS2-Textures\x - document specific",
        r"C:\Development\Git\MGS3-PS2-Textures\z - final rebuilt\BETA Textures - From Document",
        r"C:\Development\Git\MGS3-PS2-Textures\b - snake eater",
    ]
    ...
    # =====================================================
    VERIFIED_DIR = r"C:\Development\Git\MGS3-PS2-Textures\final_verification_nov22_2025"
    ...
    with open(log_path, "w", encoding="utf-8") as log:
        log.write("============================================\n")
        log.write(" MGS3 PS2 Texture Dimension Mismatch Report\n")
        log.write("============================================\n\n")
        ...
        for r in mismatch_results:
            ...
            if not_identified:
                ...
                everything_line = f"\"{full_path}\"|<\"mgs3/base textures/\" /<{'|'.join(not_identified)}>.png>\n"
                ...
                if stage_name in valid_stages:
                    ...
                    if stage_matched:
                        stage_line = f"\"{full_path}\"|<\"mgs3/base textures/\" /<{'|'.join(stage_matched)}>.png>\n"
...
def generate_confirmed_sha1_metadata():
    ...
    OUTPUT_CSV = os.path.join(ROOT_DIR, "u - dumped from subsistence", "pcsx2_confirmed_sha1_metadata.csv")
