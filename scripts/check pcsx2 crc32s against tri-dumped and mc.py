...
texture_csv = os.path.join(repo_root, "u - dumped from subsistence", "mgs3_ps2_dimensions.csv")
mc_csv = os.path.join(repo_root, "u - dumped from subsistence", "mgs3_mc_dimensions.csv")
